...
const formData = reactive({
  ...
  expectedVersion: editData.routeVersion
})
const initFormData = () => {
...
watch(
  ...
  (nV) => {
    ...
    formData.expectedVersion = nV.routeVersion
  },
  {
    immediate: true
  }
  ...
  await formEl.validate(async (valid) => {
    if (valid) {
      ...
      try {
        ...
        ElMessage.error(responseErrorMessage(error, '修改失败'))
      }
    }
  })
}

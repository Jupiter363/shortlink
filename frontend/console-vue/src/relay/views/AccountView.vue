...
<template>
  <section class="account-page">
    <header class="account-page-heading">
      <div>
        <span class="product-eyebrow">个人设置</span>
        <h1>账户中心</h1>
        <p>管理你的个人信息和当前登录。</p>
      </div>
    ...
    <div v-else class="account-layout">
      <aside class="account-identity">
        ...
        <div class="account-identity-note">
          <RIcon name="shield-check" />
          <p>保持信息准确，<br />安心管理每一次连接。</p>
        </div>
        <RRobot role="base" expression="neutral" :size="126" />
      </aside>

...
class AgentConsoleStaticResourceTest {
    ...
    void agentConsoleIndexIsServedWithChatEndpoint() throws Exception {
        mockMvc.perform(get("/agent-console/index.html"))
                ...
                .andExpect(content().string(containsString("Graph Trace")))
                ...
                .andExpect(content().string(containsString("id=\"graphTracePanel\"")))
                .andExpect(content().string(containsString("id=\"debugDataDetails\"")))
                .andExpect(content().string(containsString("id=\"sessionInput\"")))
                .andExpect(content().string(containsString("id=\"usernameInput\"")))
                .andExpect(content().string(containsString("id=\"agentTypeInput\"")))
                .andExpect(content().string(containsString("security-risk")))
                .andExpect(content().string(containsString("agentType: agentType()")))
                ...
                .andExpect(content().string(containsString("copyTraceId")))

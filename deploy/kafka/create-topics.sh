...
for topic in shortlink.click.raw.v1 shortlink.gateway.request.v1 shortlink.route.change.v1 shortlink.risk.policy.change.v1 shortlink.batch.ready.v1 shortlink.metadata.fetch.v1; do

...
class RiskResponseComposeNodeTest {
    ...
    @Test
    void unavailableEvidenceAndConflictsAreNeverRenderedAsActivatedPolicy() {
        Map<String, Object> output =
                node.compose(
                        ...
                        Map.of(),
                        List.of(
                                Map.of("status", "EVIDENCE_UNAVAILABLE"),
                                Map.of("status", "CONFLICT")));
        assertThat(output.get("pendingActions").toString())
                .contains("not_fully_applied")
                .doesNotContain("activated", "status=executed");
    }

    private final RiskResponseComposeNode node =
            new RiskResponseComposeNode("security-risk-graph", "v1", new SecurityRiskSanitizer());
                ...
                node.compose(
                        List.of(
                                Map.of(
                                        ...
                                        "high",
                                        "evidence",
                                        Map.of("ip", "192.168.1.10", "user", "visitor-001"))),
                        List.of(
                                Map.of(
                                        "name",
                                        ...
                                        true,
                                        "data",
                                        Map.of("ip", "10.0.0.9", "username", "admin"))),
                ...
                node.compose(
                        List.of(
                                Map.of(
                                        ...
                                        "medium",
                                        "arguments",
                                        Map.of("fullShortUrl", "riskLevel=high"))),
                        List.of(),
                        Map.of());
